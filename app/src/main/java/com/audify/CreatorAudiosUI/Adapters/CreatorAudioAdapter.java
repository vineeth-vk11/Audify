package com.audify.CreatorAudiosUI.Adapters;
...
import com.audify.CreatorAudiosUI.ViewHolders.CreatorAudioViewHolder;
...
public class CreatorAudioAdapter extends RecyclerView.Adapter<CreatorAudioViewHolder> {
    ...
    public CreatorAudioAdapter(Context context, ArrayList<AudioItemModel> audioItemModelArrayList, Activity activity) {
    ...
    @NonNull
    @Override
    public CreatorAudioViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(context);
        View view = layoutInflater.inflate(R.layout.list_item_creator_audio, parent, false);
        return new CreatorAudioViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CreatorAudioViewHolder holder, int position) {
