    ...
    public void onBindViewHolder(@NonNull AudioItemViewHolder holder, int position) {
        ...
        holder.audioCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((MainActivity)activity).currentPlayingAudioType = "category";
                ((MainActivity)activity).currentPlayingCategoryName = audioItemModelArrayList.get(holder.getAdapterPosition()).getCategory();
        ...
        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                if(((MainActivity) activity).currentPlayingAudioType.equals("category")
                        && ((MainActivity) activity).currentPlayingCategoryName.equals(audioItemModelArrayList.get(holder.getAdapterPosition()).getCategory())){
                    JSONObject props = new JSONObject();
                    try {
                        props.put("audioId", audioItemModelArrayList.get(holder.getAdapterPosition()).getQuestionId());
                    } catch (JSONException e) {
